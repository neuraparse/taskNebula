...
// Enums
export const projectVisibilityEnum = pgEnum('project_visibility', ['private', 'internal', 'public']);
...
export const projectMembers = pgTable('project_members', {
  ...
  canDeleteOwnComments: varchar('can_delete_own_comments', { length: 5 }).notNull().default('true'),
  canDeleteAllComments: varchar('can_delete_all_comments', { length: 5 }).notNull().default('false'),

  // Attachment Permissions
  canCreateAttachments: varchar('can_create_attachments', { length: 5 }).notNull().default('true'),
  canDeleteOwnAttachments: varchar('can_delete_own_attachments', { length: 5 }).notNull().default('true'),
  canDeleteAllAttachments: varchar('can_delete_all_attachments', { length: 5 }).notNull().default('false'),
  ...
  canDeleteOwnWorklogs: varchar('can_delete_own_worklogs', { length: 5 }).notNull().default('true'),
  canDeleteAllWorklogs: varchar('can_delete_all_worklogs', { length: 5 }).notNull().default('false'),
  ...
  projectUserIdx: uniqueIndex('project_member_project_user_idx').on(table.projectId, table.userId),
