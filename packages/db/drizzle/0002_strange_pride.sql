CREATE TYPE "public"."notification_type" AS ENUM('mention', 'comment', 'assigned', 'status_changed', 'issue_created', 'issue_updated', 'issue_linked', 'sprint_started', 'sprint_completed');--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "notification_user_read_idx" ON "notifications" USING btree ("user_id","is_read");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "notification_issue_idx" ON "notifications" USING btree ("issue_id");