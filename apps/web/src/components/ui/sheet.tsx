...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-popover text-popover-foreground border-border p-6 shadow-md max-h-[100vh] overflow-y-auto data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out',
  {
    variants: {
      side: {
