...
export function IssueLinks({ issueId, projectId }: IssueLinksProps) {
  ...
  if (allLinks.length === 0) {
    return (
      <>
        <div className="animate-fade-in text-muted-foreground flex flex-wrap items-center gap-2 text-sm">
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-6 w-6 self-end p-0 opacity-100 transition-opacity duration-150 sm:self-auto sm:opacity-0 sm:group-hover:opacity-100"
