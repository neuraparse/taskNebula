...
export default async function PublicDocumentPage({
  ...
  return (
    <main className="min-h-dvh bg-background">
      <article className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 space-y-6">
              ...
              {page.attachments.map((attachment) => (
                <li key={attachment.id}>
                  <a
                    ...
                    className="block rounded-md border border-border px-3 py-2 text-sm transition-colors duration-200 hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                  >
